...
export default function SummaryPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      router.push("/signup")
    }, 10000) // 10 second delay before auto-continuing
          ...
          <div className="space-y-8">
            ...
            <div className="pt-4 flex gap-4">
              ...
              <Button
                ...
                className="py-6 text-lg rounded-xl bg-amber-500 hover:bg-amber-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 w-4/5"
              >
